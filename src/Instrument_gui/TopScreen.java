...
public class TopScreen extends javax.swing.JFrame {
    ...
    public static final String TESTFILE_SAMPLE = "C:\\Users\\David Kloosterman\\Documents\\NetBeansProjects\\Instrument_GUI\\src\\TestInstance_pkg\\TestImage.tif";
    ...
    private void InsertCartridgeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertCartridgeButtonActionPerformed
        ...
        try {
            ...
            // temp code until real test images are generated by instrument
            testFilePath = TESTFILE_SAMPLE;

            if (test.processTest(this.instrument, this.cartridge, testFilePath)) {
